...
// logical AND between the reg passed in parameter and register a, the value is
// stored in a
void and_a(uint8_t reg);
// logical XOR between the reg passed in parameter and register a, the value is
// stored in a
void xor_a(uint8_t reg);
// logical OR between the reg passed in parameter and register a, the value is
// stored in a
